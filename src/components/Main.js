        ...
        return(
            <div className="sidebarmiddle">
                ...
                <div className="todayDate">
                    <a>Today is {todayday}, {dayNum} {todaymonth} {year}</a>
                </div>
                <div className="searchSubmit">
                    <Icon icon="ant-design:search-outlined" className="searchicon" />
                    <Link to="./MainSubmit">Submit your Trash <Icon icon="bi:download" className="downloadicon2" /></Link>
                </div>
                <div className="submitbutton"></div>
                <div className="searchbutton"></div>
                <div className="coastlineImage">
                    <a>Lets make our coastline cleaner.</a>
                    <img src={Coastline} alt="missing coastline img" width="932px" height="281px" className="coastline"></img>
                </div>
                <div className="displayMenu">
                    ...
                    <div className="timeLimit">
                        ...
                        <div className="progresscontainer">
                            ...
                            <a className="segerakirim">Ayo Segera Kirim Sampah Daur Ulang mu sebanyak-banyaknya !</a>
                        </div>
                    </div>
